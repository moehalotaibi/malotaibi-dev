...
// after line one and wiggles on hover. Under the title, the shared NN/g
// certification chip (components/certified-chip.tsx) links to the
// certificate. Static under reduced motion.
...
export default function AboutHero() {
  ...
  return (
    <>
      ...
      <MotionReveal delay={600} y={8} className="mt-6">
        <CertifiedChip />
      </MotionReveal>
    </>
  );
